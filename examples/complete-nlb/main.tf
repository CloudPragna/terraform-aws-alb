...
module "tf-lower-domain-ec2sg" {
  source = "git@github.com:foss-cafe/terraform-aws-asg.git?ref=1.0.0"
  name   = "example"
  ...
  vpc_zone_identifier       = ["subnet-asdf", "subnet-asdfg"]
  security_groups           = ["sg-qwer"]
  min_size                  = 0
  max_size                  = 1
  desired_capacity          = 1
